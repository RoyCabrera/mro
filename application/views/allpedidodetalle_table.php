...
<div class="row">
	<div class="col-md-12">
    <a style = 'position:absolute;left:350px' class='btn btn-info' href='<?php echo base_url('Pedido/AllPedidoDetalle/') ;?>'>ver Todo</a>
    <a href='<?php echo base_url('Pedido/PedidosHoy/');?>'></a>
