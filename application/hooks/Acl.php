 ...
 */
    private function roles_access()
    {
    	return array(
            //Super Administrador
            "1" => array("Login","Admin","Usuario","Menu","Insumo","Mesa","Receta","Pedido","Pedidoestado","Compra","Almacen","Venta","Configuracion","Manual"),
            //Administrador
            "2" => array("Login","Admin","Usuario","Menu","Insumo","Mesa","Receta","Pedido","Pedidoestado","Compra","Almacen","Venta","Configuracion"),
            //Mesero
            "3" => array("Login","Admin","Mesa","Pedido","Pedidoestado","Almacen","Venta"),
            //Cocinero
            "4" => array("Login","Admin","Menu","Insumo","Receta","Compra","Almacen","Pedido","Pedidoestado")
    	);
    }
