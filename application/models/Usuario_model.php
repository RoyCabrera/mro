...
class Usuario_model extends CI_Model {
 ...
 private $DB2=null ;
  ...
  public function insertar($Correo,$Nombre,$ApellidoPaterno,$ApellidoMaterno,$ID_TipoDocumento,$Documento,$ID_Perfil,$Telefono,$Clave,$Direccion,$Distrito) {
...
public function actualizar($Correo,$Nombre,$ApellidoPaterno,$ApellidoMaterno,$ID_TipoDocumento,$Documento,$ID_Perfil,$Telefono,$Clave,$Direccion,$Distrito) {
	date_default_timezone_set('America/Lima');
    $now = new DateTime();
    $data = array(
        'Nombre' => $Nombre,
