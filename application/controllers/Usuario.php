...
class Usuario extends CI_Controller {
    ...
    public function actualizar(){
        ...
        if($Insertar){
            ...
            $this->Usuario_model->insertar($Correo,$Nombre,$ApellidoPaterno,$ApellidoMaterno,$ID_TipoDocumento,$Documento,$ID_Perfil,$Telefono,$Clave,$Direccion,$Distrito);
        }else{
            $this->session->set_userdata('success', 'El usuario se actualizó correctamente');
            insertarLog("Actualizó el usuario ".$Correo);
            $this->Usuario_model->actualizar($Correo,$Nombre,$ApellidoPaterno,$ApellidoMaterno,$ID_TipoDocumento,$Documento,$ID_Perfil,$Telefono,$Clave,$Direccion,$Distrito);
        }
